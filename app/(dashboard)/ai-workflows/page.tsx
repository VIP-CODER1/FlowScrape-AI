    ...
    <div className="flex-1 flex flex-col h-full">
      <div className="flex justify-between">
        <div className="flex flex-col">
          ...
          <p className="text-muted-foreground">Manage your AI workflows</p>
        </div>
        <CreateWorkflowDialog triggerText="Create your AI Workflow" />
      </div>
    ...
    return (
      <div className="flex flex-col gap-4 h-full items-center justify-center">
        ...
        <div className="flex flex-col gap-1 text-center">
          ...
          <p className="text-sm text-muted-foreground">Click the button below to create your first AI workflow</p>
        </div>
        <CreateWorkflowDialog triggerText="Create your first AI Workflow" />
      </div>
    );
  }
